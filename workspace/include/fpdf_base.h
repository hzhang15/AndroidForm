...
typedef struct _FPDF_DOCDEST_
{
	...
	FS_LPWSTR				file_name;	/**< @brief The file name, encoded in UTF-16.*/
...
typedef struct _FPDF_LAUNCHACTION_
{
	...
	FS_CHAR*				file_name;	/**< @brief The file name, encoded in UTF-8. */
}FPDF_LAUNCHACTION;
#endif
...
typedef struct _FPDF_ANNOT_NOTEINFO_
{
	...
	FS_INT32				icon;			/**< @brief set the macro FPDF_ICONTYPE_NOTE_XXXX. */
...
#ifndef _FPDFANNOTQUADS_
#define _FPDFANNOTQUADS_
/** @brief Structure for information of quadrilateral points. Available since version 2.1. */
typedef struct _FPDF_ANNOT_QUADS_
{
	FS_INT32					quad_count;		/**< @brief The quadrilateral count of the highlight annotation. */
	FPDF_ANNOT_QUAD*			quads;			/**< @brief Quadrilaterals of the highlight annotation. */
}FPDF_ANNOT_QUADS;
#endif
...
#ifndef _FPDFANNOTINKLIST_
#define _FPDFANNOTINKLIST_
/** @brief Structure for ink list of a pencil annotation. Available since version 2.1.*/
typedef struct _FPDF_ANNOT_INKLIST_
{
	FS_INT32					line_count;		/**< @brief The line count of the pencil annotation. */
	FPDF_ANNOT_LINE*			lines;			/**< @brief Lines of the pencil annotation. */
}FPDF_ANNOT_INKLIST;
#endif
...
#ifndef _FPDFANNOTRECTANGLEINFO_
#define _FPDFANNOTRECTANGLEINFO_
/** @brief Structure for a square or circle annotation. Available since version 2.1.*/
typedef struct _FPDF_ANNOT_RECTANGLEINFO_
{
	FS_DWORD				size;			/**< @brief The size of the structure. */
	FS_INT32				type;			/**< @brief This should be ::FPDF_ANNOTTYPE_SQUARE or ::FPDF_ANNOTTYPE_CIRCLE. */
	FS_WCHAR				author[64];		/**< @brief The author of the annotation. */
	FS_ARGB					color;			/**< @brief The color of the annotation. */
	FS_INT32				opacity;		/**< @brief The opacity of the annotation. */
	FS_RECTF				rect;			/**< @brief The rectangle of the annotation. */
	FS_INT32				borderWidth;	/**< @brief The width of the border. */
	FS_WCHAR*				contents;		/**< @brief Contents of the annotation. */
}FPDF_ANNOT_RECTANGLEINFO;
#endif

#ifndef _FPDFANNOTLINEINFO_
#define _FPDFANNOTLINEINFO_
/** @brief Structure for a line or arrow annotation. Available since version 2.1.*/
typedef struct _FPDF_ANNOT_LINEINFO_
{
	FS_DWORD				size;			/**< @brief The size of the structure. */
	FS_BOOL					bOpenArrow;		/**< @brief Used to decide whether the style is "OpenArrow" or not. */
	FS_WCHAR				author[64];		/**< @brief The author of the annotation. */
	FS_ARGB					color;			/**< @brief The color of the annotation. */
	FS_INT32				opacity;		/**< @brief The opacity of the annotation. */
	FS_POINTF				startPoint;		/**< @brief The start point of the annotation. */
	FS_POINTF				endPoint;		/**< @brief The end point of the annotation.*/
	FS_INT32				lineWidth;		/**< @brief The width of the line.*/
	FS_WCHAR*				contents;		/**< @brief Contents of the annotation. */
}FPDF_ANNOT_LINEINFO;
#endif

#ifndef _FPDFANNOTFREETEXTINFO_
#define _FPDFANNOTFREETEXTINFO_
/** @brief Structure for a free text annotation. Available since version 2.1.*/
typedef struct _FPDF_ANNOT_FREETEXTINFO_
{
	FS_DWORD				size;			/**< @brief The size of the structure. */
	FS_WCHAR				author[64];		/**< @brief The author of the annotation. */
	FS_ARGB					color;			/**< @brief The text color of the annotation. */
	FS_INT32				opacity;		/**< @brief The opacity of the annotation. */
	FS_POINTF				originalPoint;	/**< @brief The start point of the annotation. The start point is the left-top point of annotation rect.*/
	FS_WCHAR*				contents;		/**< @brief Contents of the annotation. */
	FS_FLOAT				fFontsize;		/**< @brief The font size of the annotation.*/
	FS_CHAR					fontname[64];	/**< @brief The font name of the annotation.*/
}FPDF_ANNOT_FREETEXTINFO;
#endif
...
typedef struct _FPDF_ANNOT_FILEATTACHMENTINFO_
{
	...
	FS_ARGB					color;			/**< @brief The color of the annotation. */
	FS_INT32				opacity;		/**< @brief The opacity of the annotation. */
	FS_INT32				icon;			/**< @brief See the macro FPDF_ICONTYPE_FILEATTACH_XXXX*/
	FS_RECTF				rect;			/**< @brief The rectangle of the annotation. */
...
#ifndef _FPDF_DEF_ICONPROVIDER_
#define _FPDF_DEF_ICONPROVIDER_
/** @brief Structure for the provider of alternate icons. Available since version 2.1.*/
typedef struct _FPDF_ICONPROVIDER_
{
	/** @brief The size of the data structure. It must be set to <I>sizeof</I>(::FPDF_ICONPROVIDER). */
	FS_DWORD	lStructSize;
	...
	/**
	 * @brief A callback function retrieves identity information(name and version) of icon provider.
	 *
	 * @param[in] clientData		The user-supplied data.
	 * @param[out] str				Used to receive a wide string that specifies identity name string of icon provider.
	 * @param[out] ver				Used to receive the version number of icon provider.
	 *
 	 * @return None
	 *
	 * @note	This callback function should return valid identity name string and version number.
	 */
	void			(*GetProviderID)(FS_LPVOID clientData, FS_WSTR* str, FS_DWORD* ver);

	/**
	 * @brief A callback function determines whether icon provider supports an icon or not.
	 *
	 * @param[in] clientData		The user-supplied data.
	 * @param[in] iconType			A string that specified the type of icon. Currently only support two types: "Text" and "FileAttachment".
	 * @param[in] iconID			A string that specified identity string of icon. Refer to Note part in this function's comment.
	 *
	 * @return	<b>TRUE</b> means support an icon, while <b>FALSE</b> means not support.
	 *
	 * @note	<ul>
	 *			<li>
	 *			For <b>Text</b> annotation, valid icon identity strings are:<br>
	 *				Checkmark, Circle, Comment, Cross, Help, Insert, Key, NewParagraph, 
	 *				Note, Paragraph, RightArrow, RightPointer, Star, UpArrow, UpLeftArrow.<br>
	 *			</li>
	 *			<li>
	 *			For <b>FileAttachment</b> annotation, valid icon identity strings are:
	 *				Graph, PushPin, Paperclip, Tag.
	 *			</li>
	 *			</ul>
	 */
	FS_BOOL			(*HasIcon)(FS_LPVOID clientData, FS_LPCSTR iconType, FS_LPCSTR iconID);

	/**
	 * @brief A callback function determines whether to support to change icon color or not.
	 *
	 * @param[in] clientData		The user-supplied data.
	 * @param[in] iconType			A string that specified the type of icon. Currently only support two types: "Text" and "FileAttachment".
	 * @param[in] iconID			A string that specified identity string of icon. Refer to Note part in FPDF_ICONPROVIDER::HasIcon.
	 *
	 * @return	<b>TRUE</b> means support to change color, while <b>FALSE</b> means not support.
	 */
	FS_BOOL			(*CanChangeColor)(FS_LPVOID clientData, FS_LPCSTR iconType, FS_LPCSTR iconID);
	 ...
	 * @param[in] iconType			A string that specified the type of icon. Currently only support two types: "Text" and "FileAttachment".
	 * @param[in] iconID			A string that specified identity string of icon. Refer to Note part in FPDF_ICONPROVIDER::HasIcon.
	 * @param[in] color				The color value if icon needed. Format: 0xAARRGGBB, and alpha component is ignored.
	 *
	 * @return	A PDF page handle which contains icon contents. <b>NULL</b>means there is no icon data.
	 */
	FPDF_PAGE		(*GetIcon)(FS_LPVOID clientData, FS_LPCSTR iconType, FS_LPCSTR iconID, FS_ARGB color);

	/**
	 * @brief	A callback function retrieves shading colors if an icon supports shading.
	 *			Currently, we support only Type-2 shading settings with two color values.
	 *
	 * @details	There may exist more than one shading for an icon. 
	 *			So, this function may be called several times by SDK and parameter <i>shadingIndex</i> indicates the index of shading.
	 *
	 * @param[in] clientData		The user-supplied data.
	 * @param[in] iconType			A string that specified the type of icon. Currently only support two types: "Text" and "FileAttachment".
	 * @param[in] iconID			A string that specified identity string of icon. Refer to Note part in FPDF_ICONPROVIDER::HasIcon.
	 * @param[in] refColor			Referenced color to set. Format: 0xAARRGGBB, and alpha component is ignored.
	 * @param[in] shadingIndex		Index of shading. 
	 * @param[out] c1				Used to receive first color value of shading.
	 * @param[out] c2				Used to receive second color value of shading.
	 *
	 * @return	<b>TRUE</b> means success, while <b>FALSE</b> means any error occurs.
	 */
	FS_BOOL			(*SetShadingColor)(FS_LPVOID clientData, FS_LPCSTR iconType, FS_LPCSTR iconID, FS_ARGB refColor, FS_INT32 shadingIndex, FS_ARGB* c1, FS_ARGB* c2);

	/**
	 * @brief	A callback function retrieves icon size for display, in device size(pixel normally).
	 *
	 * @param[in] clientData		The user-supplied data.
	 * @param[in] iconType			A string that specified the type of icon. Currently only support two types: "Text" and "FileAttachment".
	 * @param[in] iconID			A string that specified identity string of icon. Refer to Note part in FPDF_ICONPROVIDER::HasIcon.
	 * @param[out] width			Used to receive the width of icon.
	 * @param[out] height			Used to receive the height of icon.
	 * 
	 * @return	<b>TRUE</b> means success, while <b>FALSE</b> means any error occurs.
	 */
	FS_BOOL			(*GetDisplaySize)(FS_LPVOID clientData, FS_LPCSTR iconType, FS_LPCSTR iconID, FS_FLOAT* width, FS_FLOAT* height);

}FPDF_ICONPROVIDER;
#endif //_FPDF_DEF_ICONPROVIDER_
...
/** @brief Square annotation. Available since version 2.1.*/
#define FPDF_ANNOTTYPE_SQUARE				7
/** @brief Rectangle annotation. Available since version 2.1.*/
#define FPDF_ANNOTTYPE_CIRCLE				8
/** @brief Line annotation. Available since version 2.1.*/
#define FPDF_ANNOTTYPE_LINE					9
/** @brief Underline annotation. Available since version 2.1.*/
#define FPDF_ANNOTTYPE_UNDERLINE			10
/** @brief Strikeout annotation. Available since version 2.1.*/
#define FPDF_ANNOTTYPE_STRIKEOUT			11
/** @brief Squiggly annotation. Available since version 2.1.*/
#define FPDF_ANNOTTYPE_SQUIGGLY				12
/** @brief FreeText annotation. Available since version 2.1.*/
#define FPDF_ANNOTTYPE_FREETEXT				13
/**@}*/

/**
 * @name Macro Definitions for icon type. Available since version 2.1.
 */
/**@{*/
...
#define FPDF_ICONTYPE_NOTE_RIGHARROW		10
/** @brief Note icon type: Right Pointer. */
#define FPDF_ICONTYPE_NOTE_RIGHPOINTER		11
...
/** @brief The file data of fileattachment annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_FILEDATA			8
/** @brief The modification time of annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_MODTIME			9
/** @brief The ink list of pencil annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_PENCIL_INKLIST		10
/** @brief The start point of line annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_LINE_STARTPOINT		11
/** @brief The end point of line annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_LINE_ENDPOINT		12
/** @brief The font name of free text annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_FREETEXT_FONTNAME	13
/** @brief The font size of free text annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_FREETEXT_FONTSIZE	14
/** @brief The text color of free text annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_FREETEXT_TEXTCOLOR	15
/** @brief The quad points of text markup annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_TEXTMARKUP_QUADPOINTS	16
/** @brief The icon type of the annotation, such as text or file attachment annotation. Available since version 2.1.*/
#define FPDF_ANNOTINFO_ICONTYPE				17
/**@}*/
...
/** @brief Limit image cache size. If set, the limit will be 100M. Available since version 2.1.*/
#define FPDF_RENDER_LIMITEDIMAGECACHE	0x20
/** @brief Set if do not need rotate or scale annotation icon, for "Text" and "FileAttachment" only at present. Available since version 2.1.*/
#define FPDF_RENDER_NOTTRANSFORMICON	0x40	 
/** @brief Disable native text rendering feature (like GDI+, CGContext). Available since version 2.1. */
#define FPDF_RENDER_NO_NATIVETEXT		0x80
/** @brief Grayscale output. Only used in ::FPDF_FormFill_Draw. */
#define FPDF_RENDER_GRAYSCALE			0x100	
/** @brief Whether rendering is for printing or not. Currently, only useful for ios. Available since version 2.1.*/
#define FPDF_RENDER_PRINT				0x200
...
/**
 * @name Macro Definitions for common Form Field Flags.
 */
/**@{*/
...
/**
 * @name Additional flags for radio button fields. Available since version 2.1.
 */
/*@{*/
/**
 ...
 */
#define FPDF_FIELDFLAG_RADIO_NOTOGGLEOFF	0x100
/**
 * @brief	If set, radio buttons with same value in a field will be turned on or off
 *			in unison (either all on, or all off). 
 *			If cleared, all buttons are mutually exclusive.
 */
#define FPDF_FIELDFLAG_RADIO_UNISON			0x200
/*@}*/

/**
 * @name Additional flags for text fields. Available since version 2.1.
 */
/*@{*/

/** @brief	Multiple lines. */
#define FPDF_FIELDFLAG_TEXT_MULTILINE		0x100
/** @brief	This is a password field. Password shouldn't be displayed or exported. */
#define FPDF_FIELDFLAG_TEXT_PASSWORD		0x200
/**
 * @brief	Do not scroll: vertical scroll for multi-line field, or horizontal scroll for single-line field. 
 *			If the field is full, no more text is accepted.
 */
#define FPDF_FIELDFLAG_TEXT_NOSCROLL		0x400
/**
 * @brief	If set, this field is arranged in a number of equally spaced positions ("combs").
 */
#define FPDF_FIELDFLAG_TEXT_COMB			0x800
/*@}*/

/**
 * @name Additional flags for combo box fields. Available since version 2.1.
 */
/*@{*/
/**
 * @brief	(Meaningful only when ::FPDF_FIELDFLAG_TEXT_COMB flag is set): 
 *			if set, the combo box includes an editable text control as well as a drop-down list, otherwise it includes only a drop-down list.
 */
#define FPDF_FIELDFLAG_COMBO_EDIT			0x100
/*@}*/

/**
 * @name Additional flags for list box fields. Available since version 2.1.
 */
/*@{*/
/** @brief If set, more than one items can be selected. */
#define FPDF_FIELDFLAG_LIST_MULTISELECT		0x100
/*@}*/

/**
 * @name Macro definitions for 'Q' entry in field dictionary which common to all fields containing variable text. Available since version 2.1.
 * @note These specify the form of quadding (justification) to be used in displaying the text.
 */
/*@{*/
/** @brief Left-justified.*/
#define  FPDF_JUSTIFICATION_LEFT	0
/** @brief Centered.*/
#define  FPDF_JUSTIFICATION_CENTER	1
/** @brief Right-justified.*/
#define  FPDF_JUSTIFICATION_RIGHT	2
/*@}*/
...
#ifndef _FPDF_DEF_MACRO_PAGEROTATION_
#define _FPDF_DEF_MACRO_PAGEROTATION_
/**
...
/** @brief	No rotation. */
#define	FPDF_PAGEROTATION_0			0
/** @brief	Rotate 90 degrees in clockwise direction. */
#define	FPDF_PAGEROTATION_90		1
/** @brief	Rotate 180 degrees in clockwise direction. */
#define	FPDF_PAGEROTATION_180		2
/** @brief	Rotate 270 degrees in clockwise direction. */
#define	FPDF_PAGEROTATION_270		3

/**@}*/
#endif /* _FPDF_DEF_MACRO_PAGEROTATION_ */
 ...
 *
 * @details If application needs to use private icon appearance, application should use this function to set an icon provider.
 *
 * @param[in] iconProvider		Pointer to structure of ::FPDF_ICONPROVIDER.
 *
 ...
 */
FS_RESULT	FPDF_IconProvider_Set(FPDF_ICONPROVIDER* iconProvider);

/**
 * @brief Release icon provider.
 *
 * @details Remove icon provider from SDK management, and this function will call FPDF_ICONPROVIDER::Release automatically.
 *
 * @param[in] iconProvider		Pointer to structure of <b>FPDF_ICONPROVIDER</b>.
 *
 * @return 	::FS_ERR_SUCCESS means success.<br>
 *			For more definitions please see macro definitions <b>FS_ERR_XXX</b>.
 *
 * @note Available since version 2.1.
 */
FS_RESULT	FPDF_IconProvider_Release(FPDF_ICONPROVIDER* iconProvider);
